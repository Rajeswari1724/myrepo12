...
public class Factory {
	...
	public void register() {
		...
		register.setUsername(username);                   //y we are setting
		...
		if (password.equals(confirmPassword)) {
			register.setConfirmpassword(confirmPassword);   //password == confirm password equal aethene set cheyali. andhuke if condition lone use cheyali.
			                                                // .okavela outside lona setxx method thisukunte password and confirm password equal kakapoena set chestundhi
